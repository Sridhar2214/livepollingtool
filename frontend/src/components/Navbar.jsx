      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2.5 group">
          ...
          <span className="text-xl font-black text-slate-900 tracking-tight">
            Live<span className="text-blue-600">Poll</span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-3">
          {user ? (
            ...
            <>
              ...
              <Link
                to="/register"
                className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-xs shadow-sm shadow-blue-600/20 transition"
              >
